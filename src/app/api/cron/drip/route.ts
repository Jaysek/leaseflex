    ...
    html: (name: string) => `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 24px;">
        ...
        <div style="background: #fafafa; border-radius: 12px; padding: 20px; margin: 24px 0;">
          <p style="font-size: 14px; color: #525252; margin: 0;">LeaseFlex covers these costs for as little as <strong style="color: #171717;">$12/month</strong>. That's less than a streaming subscription &mdash; for thousands in protection.</p>
        </div>
